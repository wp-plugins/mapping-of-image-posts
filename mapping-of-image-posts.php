...
<div class="postbox" style="float:left; display:block; width:auto; height:auto; padding:10px;margin-top:10px;">
	...
	<p id="moip_download_file">Download resulted file from <a href="<?php echo 'http://' . $_SERVER['SERVER_NAME'] . '/wp-content/uploads/mapping-of-image-posts/' . basename(get_transient('mapping_of_image_posts_filename')); ?>" >here</a></p>
</div><!-- .postbox -->
